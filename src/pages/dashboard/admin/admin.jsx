...
<div className='flex'>
    ...
    <div className="flex flex-col items-center mt-6 -mx-2">
        ...
        <h4 className="mx-2 mt-2 font-medium text-green-800 dark:text-green-200">Admin A.N</h4>
        <p className="mx-2 mt-1 text-sm font-medium text-green-600 dark:text-green-400">admin@admin.com</p>
    </div>

    <div className="flex flex-col justify-between flex-1 mt-6">
        <nav>
            <a className="flex items-center px-4 py-2 text-green-700 bg-green-100 rounded-lg dark:bg-green-800 dark:text-green-200" >
                ...
                <Link to="/Users" className="mx-4 font-medium">Dashboard</Link>
            </a>
