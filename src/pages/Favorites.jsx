                        ...
                        {item.favorite.recipe ? (
                            ...
                            <>
                                ...
                                <div className="flex flex-col gap-2">
                                    ...
                                    <div className="font-serif">{item.favorite.recipe.ingrediants}</div>
                                    <div className="w-full h-4 rounded-md">{item.favorite.recipe.cooking_time}</div>
                                    <div className="w-2/4 h-4 rounded-md">{item.favorite.recipe.nutrition_information}</div>
                            ...
                            <div className="h-12 w-12 rounded-full bg-neutral-400/50 overflow-hidden">
                             ...
                             {item.favorite.coache && (
                                    <div className="font-serif">
                                        Name: {item.favorite.coache.experience}, Bio: {item.favorite.coache.bio}
                                    </div>
